...
revoke all on function public.abhi_apply_legacy_due_dates(uuid,jsonb,integer,text) from public, anon, authenticated;
grant execute on function public.abhi_apply_legacy_due_dates(uuid,jsonb,integer,text) to service_role;
